...
open class ExpandableTextView: AppCompatTextView {
	 ...
	 * @see [onStateChange]
	 * */
	private var onStateChangeListener: (ExpandableTextView.(oldState: State, newState: State) -> Unit)? = null
	...
	private fun initAttrs(attrs: AttributeSet? = null, defStyleAttr: Int = 0, defStyleRes: Int = 0) {
		super.setEllipsize(TextUtils.TruncateAt.END)
		context.obtainStyledAttributes(attrs,
			R.styleable.ExpandableTextView, defStyleAttr, defStyleRes).apply {
